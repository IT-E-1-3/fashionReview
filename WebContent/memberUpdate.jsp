	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4"
			...
			<div class="w3-center w3-large w3-margin-top">
				<h3><%=user.getId()%>님의 회원정보
				</h3>
			</div>
			<div>
				<form action="memberUpdate" method="post">
					<p>
						<label>ID : <%=user.getId()%></label> <input class="w3-input"
							type="text" id="id" name="id" readonly
							value="<%=user.getId()%>">
					</p>
					<p>
						<label>Pw : <%=user.getPw()%></label> <input class="w3-input"
							type="text" id="pw" name="pw" value="<%=user.getPw()%>">
					</p>
					<p>
						<label>Name : <%=user.getName()%></label> <input
							class="w3-input" type="text" id="name" name="name"
							value="<%=user.getName()%>">
					</p>
					<p>
						<label>Email : <%=user.getEmail()%></label> <input
							class="w3-input" type="text" id="email" name="email"
							value="<%=user.getEmail()%>">
					</p>
					<p>
						<label>Phone : <%=user.getPhone()%></label> <input
					...
					<p>
						<label>Height : <%=user.getHeight()%></label> <input
							class="w3-input" type="text" id="height" name="height"
							value="<%=user.getHeight()%>">
					</p>
					<p>
						<label>Weight : <%=user.getWeight()%></label> <input
							class="w3-input" type="text" id="weight" name="weight"
