...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      //id:WriteBtn 누를시 title, content값 NullPointException 방지
...
<!-- 세션에 저장된 id값 받아오기 -->
   ...
   <div class="main">
      <div class="main-container">
         ...
         <!-- 작성버튼 클릭시 BoardWriteServlet으로 post 매핑 -->
         <form action="boardWrite" method="post" enctype="multipart/form-data">
            <div class="row row-cols-lg-10 mt-5">
               <table class="table table-striped mytable"
                  ...
                  <tr>
                     <td>아이디</td>
                     <td><input style="width: 400px;" name="user_id" id="id"
                        value="<%=id%>" readonly style="background:lightgray"></td>
                  </tr>
                  <tr>
                     <td>제목</td>
                     <td><input style="width: 400px;" list="browsers"
                  ...
                  <tr>
                     ...
                     <label><input type="checkbox" name="category" value="Accessories">악세사리</label></td>
                  </tr>
            ...
            <footer>
               <nav aria-label="Page navigation example"
                  ...
                  <ul class="pagination">
                  <!-- 작성버튼 클릭시 BoardWriteServlet으로 post 매핑 -->
                     <li><input type="submit" value="작성" id="writeBtn"
                        class="btn btn-secondary"></li>
                  <!-- boardList.jsp로 페이지 전환 -->
                     <li><input type="button" onclick="location='boardList.jsp'"
                        class="btn btn-secondary" value="목록"></li>
                  </ul>
               </nav>
            </footer>
         </form>
